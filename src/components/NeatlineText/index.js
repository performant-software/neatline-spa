...
class NeatlineText extends Component {
    constructor( props ) {
        super( props );
...
NeatlineText = reduxForm({form: 'exhibit',enableReinitialize:true})(NeatlineText);
...
export default connect(mapStateToProps, mapDispatchToProps)(NeatlineText);
